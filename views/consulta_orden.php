...
$consulta = "select a.id_orden, a.fecha, a.nombre, b.nombre as laboratorio from orden a
inner join laboratorios b where a.id_orden = b.id_laboratorio order by a.id_orden desc";
?>
            ...
            <div class="tabla_fichas">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="./modificar_orden.php?id=<?php echo $row["id_orden"];?>" class="enlace_edicion">Editar</a>
