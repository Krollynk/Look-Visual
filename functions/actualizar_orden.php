...
$guardarpedido = "call sp_actualizar_orden('$id_orden','$fecha','$nombre','$id_laboratorio','$armazon','$od_esf','$od_cil','$od_eje','$od_add','$od_prisma','$oi_esf','$oi_cil','$oi_eje','$oi_add','$oi_prisma','$dip','$altura','$puente','$horizontal','$vertical','$diagonal','$material')";

$resultado = mysqli_query($con_db, $guardarpedido);

if($resultado){
    echo "<script>alert('Se ha registrado correctamente'); window.location='../views/consulta_orden.php'</script>";
}else{
