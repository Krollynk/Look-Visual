...
$guardarventa = "call sp_venta('$id_venta','$fecha','$nombre','$abono','$saldo','$fecha_entrega','$lente','$precio_lente','$montura','$precio_montura','$estuche','$spray','$precio_accs','$total')";
$resultado = mysqli_query($con_db, $guardarventa);

if($resultado){
    echo "<script>alert('Se ha registrado correctamente'); window.location='../views/venta.php'</script>";
}else{
